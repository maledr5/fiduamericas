...
<div>
	<ul className="no-bullets">
		<li><strong>Paso 1:</strong> Asesórate, nuestro objetivo es conocer tus necesidad y expectativas para poder ofrecerte el tipo de fondo que más te convenga. </li>
		...
		<li><strong>Paso 4:</strong> Invierte, tienes que transferir o depositar en nuestras cuentas bancarios los correspondientes montos. </li>
